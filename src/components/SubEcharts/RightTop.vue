 ...
 * @LastEditTime: 2019-12-17 15:38:47
 ...
 <template>
    <div class="wrap1">
        ...
        <div class="con">
            <!-- 仪表盘 -->
            <div id="circle"></div>
            <el-popover placement="right" width="500" trigger="click" class="popupWidow">
                <el-table :data="gridDatas">
                    <el-table-column width="100" property="comname" label="机构" offset="100"></el-table-column>
