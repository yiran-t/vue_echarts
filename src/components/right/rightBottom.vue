...
.ranking ul li:nth-child(odd) {
    background-image: linear-gradient(to top, rgba(220, 105, 105, 0), rgba(220, 105, 105, 0.3));
}

.ranking ul li:nth-child(even) {
    background-image: linear-gradient(to top, rgba(92, 124, 220, 0), rgba(92, 124, 220, 0.3));
}
...
.Figure>ul>li:nth-child(1){
    margin-right: 0.2rem;
}
.Figure>ul>li>span:nth-child(1){
    display: inline-block;
    width: 0.3rem;
    height: 0.18rem;
