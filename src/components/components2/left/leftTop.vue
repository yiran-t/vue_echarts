    ...
    <div class="topTower">
        ...
        <el-popover
            ...
            <el-table :data="insureRateTK">
                <el-table-column width="125" property="comname" label="机构"></el-table-column>
                <el-table-column width="110" property="totalsumreal" label="实际投保件数"></el-table-column>
                <el-table-column width="110" property="totalsumpre" label="预约投保件数"></el-table-column>
