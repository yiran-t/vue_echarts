<template>
    <div id="wrap">
        <el-row class="title">
            <span @click= 'logOut' id="logOut" style="font-size: 0.14rem;display: inline-block;color: #c0c4cc;padding: 0.04rem 0.06rem;border-radius: 0.04rem;border: 0.01rem solid #667dab;margin-top: 0.2rem;margin-left: 0rem;">退出登录</span>
        ...
        <div class="main">
            <div class="left">
                <div class="left1">
                    ...
                    <div class="leftTop">
                        ...
                        <div class="leftBottom">
                            <div class="topVip">
                                <img src="../assets/image/little01.png" class="topVipImg">
                                <span class="topVipSpan">待收费 <i style="font-size: 0.12rem;">(单位：万元)</i></span>
                            </div>
                            <leftMid></leftMid>
                        </div>
                    </div>
                ...
                <div class="left2">
                    <div class="topVip">
                        <img src="../assets/image/little01.png" class="topVipImg">
                        <span class="topVipSpan">客户数 <i style="font-size: 0.12rem">(单位: 人)</i></span>
                    </div>
                    <div class="leftBot">
            ...
            <div class="right">
                <div class="right1">
                    <div class="topVip">
                        <img src="../assets/image/little01.png" class="topVipImg">
                        <span class="topVipSpan">大单排名 <i style="font-size: 0.12rem;">(单位: 万元)</i></span>
                    </div>
                    <div class="rightTop">
                        <rightTop></rightTop>
                    </div>
                ...
                <div class="right2">
                    <div class="topVip">
                        <img src="../assets/image/little01.png" class="topVipImg">
                        <span class="topVipSpan">当月人力 <i style="font-size: 0.12rem;">(单位: 人)</i></span>
                    </div>
...
import leftMid from '../components/left/leftMid'
import leftBottom from '../components/left/leftBottom'
import rightTop from '../components/right/rightTop'
import rightBottom from '../components/right/rightBottom'
import midMap from '../components/mid/map'
import viewData from '../components/mid/viewData'
