 ...
 * @LastEditTime: 2019-12-14 10:37:53
...
<!-- tatal Box -->
    ...
    <!-- 总标题 -->
        <el-row id="rowTopBox">
            ...
            <span @click= 'back' style="position: absolute;font-size: 0.14rem;display: inline-block;color: #c0c4cc;padding: 0.04rem 0.06rem;border-radius: 0.04rem;border: 0.01rem solid #667dab;margin-top: 0.2rem;margin-left: 0.2rem;">返回</span>
            <span @click= 'logOut' style="position: absolute;font-size: 0.14rem;display: inline-block;color: #c0c4cc;padding: 0.04rem 0.06rem;border-radius: 0.04rem;border: 0.01rem solid #667dab;margin-top: 0.2rem;margin-left: 0.8rem;">退出登录</span>
...
<script>
import Left from '../components/SubEcharts/Left.vue'
import Right from '../components/SubEcharts/Right.vue'
import midMap from '../components/SubEcharts/map.vue'
import viewData from '../components/SubEcharts/viewData.vue'
